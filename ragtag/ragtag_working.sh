...
cd /mnt/griffin/chrwhe/Vanessa_cardui/genome/synteny
...
# export PATH=$PATH:/data/programs/RagTag/

# run
python3 /data/programs/RagTag/ragtag_scaffold.py $reference $query -o Mcin_Vcard_default -t 10 --aligner nucmer
...
# could be the settings, what if I used previous delta?
mkdir nucmer_aln_Mcin_v_Vcar.qr1_u80_filter
cd nucmer_aln_Mcin_v_Vcar.qr1_u80_filter
ln -s /mnt/griffin/chrwhe/Vanessa_cardui/genome/synteny/nucmer_aln_Mcin_v_Vcar.qr1_u80_filter.delta .
python3 /data/programs/RagTag/ragtag_delta2paf.py nucmer_aln_Mcin_v_Vcar.qr1_u80_filter.delta > query_against_ref.paf
...
# provide aligner. Uses minimap or nucmer
export PATH=$PATH:/data/programs/mummer-4.0.0beta2/
python3 /data/programs/RagTag/ragtag_scaffold.py $reference $query -o Mcin_Vcard -t 10 --aligner nucmer --nucmer-params '--mum -c 100'
...
export PATH=$PATH:/data/programs/mummer-4.0.0beta2/
python3 /data/programs/RagTag/ragtag_scaffold.py $reference $query -o Mcin_Vcard_default -t 10 --aligner nucmer
nucmer -l 100 -c 500 -p /mnt/griffin/chrwhe/Vanessa_cardui/genome/synteny/ragtag/Mcin_Vcard_default/query_against_ref /mnt/griffin/chrwhe/Vanessa_cardui/genome/synteny/ragtag/cinxiav2.fasta /mnt/griffin/chrwhe/Vanessa_cardui/genome/synteny/ragtag/Vcar.v1.scaf.fasta 2> /mnt/griffin/chrwhe/Vanessa_cardui/genome/synteny/ragtag/Mcin_Vcard_default/query_against_ref.delta.log

export PATH=$PATH:/data/programs/mummer-4.0.0beta2/
python3 /data/programs/RagTag/ragtag_scaffold.py $reference $query -o Mcin_Vcard_mum_c100l20 -t 10 --aligner nucmer  --nucmer-params '--mum -c 100 -l 20'
...
scp chrwhe@miles.zoologi.su.se:/mnt/griffin/chrwhe/Vanessa_cardui/genome/synteny/ragtag/nucmer_aln_Mcin_v_Vcar.qr1_u80_filter/pseudochromosomal.zip .
